...
interface Props extends StackScreenProps<RootStackParams, 'TalismanScreen'> { };


export const TalismanScreen = ({ navigation, route }: Props) => {

    const { TalismanData } = route.params;

    const { name, image, description, effect } = TalismanData;
