...
interface Props extends StackScreenProps<RootStackParams, 'CreatureScreen'> { };


export const CreatureScreen = ({ navigation, route }: Props) => {

    const { CreatureData } = route.params;

    const { name, image, description, location, drops } = CreatureData;
