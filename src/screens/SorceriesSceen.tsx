...
interface Props extends StackScreenProps<RootStackParams, 'SorceriesScreen'> { };


export const SorceriesScreen = ({ navigation, route }: Props) => {

    const { SorceriesData } = route.params;

    const { name, image, description, type, cost, slots, effects, requires } = SorceriesData;
